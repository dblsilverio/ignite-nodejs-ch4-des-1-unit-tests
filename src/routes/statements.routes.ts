...
import { BalanceTransferController } from '../modules/statements/useCases/balanceTransfer/BalanceTransferController';
...
const balanceTransfer = new BalanceTransferController();
...
statementRouter.post('/transfers/:user_id', balanceTransfer.handle);
